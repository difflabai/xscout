...
def main():
    ...
    parser.add_argument(
        "--source", default="x", choices=["x", "reddit", "civitai", "arxiv", "lobsters", "hackernews", "all"],
        help="Source to pull from: x, reddit, civitai, arxiv, lobsters, hackernews, or all (default: x)",
    )

...
Pulls posts from X, Reddit, CivitAI, and other sources → sends to NanoGPT LLM API → outputs intel brief.
...
def main():
    ...
    parser.add_argument(
        "--source", default="x", choices=["x", "reddit", "civitai", "github", "all"],
        help="Source to pull from: x, reddit, civitai, github, or all (default: x)",
    )

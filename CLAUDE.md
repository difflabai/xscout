...
Automated local AI intel scout. Pulls tweets about local/on-device AI from the X API, sends them to the Claude API, and generates a structured intel brief.
